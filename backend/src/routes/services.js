...
// GET všechny služby
router.get('/', authMiddleware, authorize('billing:read'), async (req, res) => {
  try {
...
// GET detail služby
router.get('/:id', authMiddleware, authorize('billing:read'), async (req, res) => {
  try {
...
router.post('/', authMiddleware, authorize('billing:write'), async (req, res) => {
  try {
...
router.put('/:id', authMiddleware, authorize('billing:write'), async (req, res) => {
  try {
    const { id } = req.params;
...
router.delete('/:id', authMiddleware, authorize('billing:write'), async (req, res) => {
  try {
    const { id } = req.params;
...
router.post('/bulk', authMiddleware, authorize('billing:write'), async (req, res) => {
  try {
      ...
      try {
        ...
        const created = await prisma.service.create({
          data: {
            ...
            monthlyPriceCents: toCents(service.monthlyPrice),
